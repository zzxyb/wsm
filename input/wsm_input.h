...
struct wsm_input_device {
	struct wl_listener
		device_destroy; /**< Listener for handling device destruction events */
	struct wl_list link; /**< Link for managing a list of input devices */

	char *identifier; /**< Identifier for the input device */
	char *mapped_output_id;
	float scroll_factor;
	struct wlr_input_device *
		input_device_wlr; /**< Pointer to the associated WLR input device */
	const struct wsm_input_device_impl *
		input_device_impl_wsm; /**< Pointer to the implementation of the input device */
...
struct wsm_input_device_impl {
	 ...
	 * @return Status of the configuration
	 */
	enum libinput_config_status (*set_accel_speed)(
	 ...
	 * @return Status of the configuration
	 */
	enum libinput_config_status (*set_rotation_angle)(
	 ...
	 * @return Status of the configuration
	 */
	enum libinput_config_status (*set_natural_scroll)(
	 ...
	 * @return Status of the configuration
	 */
	enum libinput_config_status (*set_left_handed)(
	 ...
	 * @return Status of the configuration
	 */
	enum libinput_config_status (*set_scroll_button)(
	 ...
	 * @return Status of the configuration
	 */
	enum libinput_config_status (*set_dwtp)(
	 ...
	 * @return Status of the configuration
	 */
	enum libinput_config_status (*set_calibration_matrix)(
