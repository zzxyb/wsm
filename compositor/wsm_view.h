...
/**
 * @brief Checks whether a view should expose a maximize button
...
/**
 * @brief Checks whether a view should expose a minimize button
 * @param view Pointer to the view
 * @return true when minimize should be available
 */
