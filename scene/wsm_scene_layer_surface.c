...
static void scene_layer_surface_handle_layer_surface_destroy(
	...
	wsm_scene_node_destroy(&scene_layer_surface->tree->node);
}
...
void wsm_scene_layer_surface_v1_configure(
	...
	wsm_scene_node_set_position(&scene_layer_surface->tree->node, box.x, box.y);
...
struct wsm_scene_layer_surface_v1 *wsm_scene_layer_surface_v1_create(
	...
	scene_layer_surface->tree = wsm_scene_tree_create(parent);
	...
	struct wsm_scene_tree *surface_tree = subsurface_tree->tree;
