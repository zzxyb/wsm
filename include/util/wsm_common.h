/**
 * @file        wsm_common.h
 * @brief       Common utility macros and helpers for wlframe.
 * @details     This file contains shared helpers for string formatting,
 *              lenient string handling, color conversion, time conversion,
 *              bounds macros, and small inline convenience functions.
 * @author      YaoBing Xiao
 * @date        2026-07-21
 * @version     v1.0
 * @par Copyright(c):
...
#ifndef UTIL_WSM_COMMON_H
#define UTIL_WSM_COMMON_H
...
#ifdef __GNUC__
/**
 * @brief Adds GCC printf-style format checking to a function declaration.
 * @param start Index of the format string argument.
 * @param end Index of the first variadic argument, or 0 for va_list functions.
 */
...
/**
 * @brief Allocates and formats a string using printf-style arguments.
 * @param str_out Pointer to receive the newly allocated string.
 * @param fmt Format string.
...
/**
 * @brief Removes a chunk of an array at an offset.
...
/**
 * @brief Grows or shrinks an array to a requested size.
